...
def numerical_derivative(values: np.ndarray, time_s: np.ndarray) -> np.ndarray:
...
def derivative_error_summary(
    values: np.ndarray, time_s: np.ndarray, exact_derivative: np.ndarray
...
def trapezoidal_integral(values: np.ndarray, time_s: np.ndarray) -> float:
...
def cumulative_trapezoidal_integral(
    values: np.ndarray, time_s: np.ndarray, initial: float = 0.0
) -> np.ndarray:
